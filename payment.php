                            ...
                            <div class="card-body">
                                ...
                                <form class="form" role="form" autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cc_name" pattern="\w+ \w+.*" title="First and last name" placeholder="Enter Your full name"required="required">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Pin</label>
                                        <input type="text" class="form-control" autocomplete="off" maxlength="20" pattern="\d{16}" title="Credit card number" placeholder=" Enter Pin number"required="">
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-6">Medicine Name</label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" autocomplete="off" maxlength="40" pattern="\d{16}" title="Credit card number" placeholder=" Enter Medicine name"required="">
                                        </div>
